...
var ThumbnailImage = function ThumbnailImage(_ref) {
  var snapshot = _ref.snapshot,
    alt = _ref.alt, className = _ref.className;

  return React.createElement(
    'div',
    { className: 'react-video-thumbnail-image' },
    React.createElement('img', { src: snapshot, alt: alt, className: className })
  );
};

var VideoImageThumbnail = function (_React$Component) {
  inherits(VideoImageThumbnail, _React$Component);

  function VideoImageThumbnail(props) {
    classCallCheck(this, VideoImageThumbnail);

    var _this = possibleConstructorReturn(this, (VideoImageThumbnail.__proto__ || Object.getPrototypeOf(VideoImageThumbnail)).call(this, props));
    ...
    _this.state = {
      ...
      renderThumbnailHtml: props.renderThumbnailHtml, // boolean
      ...
      alt: props.alt, // string
      className: props.className // string
    };
    return _this;
  }

  createClass(VideoImageThumbnail, [{
    key: 'render',
    value: function render() {
      var _this2 = this;

      var _state = this.state,
        renderThumbnailHtml = _state.renderThumbnailHtml,
      ...
      if (!snapshot) {
        return React.createElement(
          'div',
          { className: 'react-video-thumbnail-image' },
          React.createElement('canvas', { className: 'snapshot-img-generator', ref: 'canvas' }),
          React.createElement('video', {
            muted: true,
            className: 'snapshot-img-generator',
            ref: 'videoEl',
            src: videoUrl,
        ...
        if (renderThumbnailHtml) {
          return React.createElement(ThumbnailImage, { snapshot: snapshot, alt: alt, className: className });
        } else {
          return snapshot;
        }
      }
...
VideoImageThumbnail.propTypes = {
  cors: propTypes.bool,
  width: propTypes.number,
  height: propTypes.number,
  renderThumbnailHtml: propTypes.bool,
   ...
   * Default Properties
   */
}; VideoImageThumbnail.defaultProps = {
  cors: false,
...
module.exports = VideoImageThumbnail;
